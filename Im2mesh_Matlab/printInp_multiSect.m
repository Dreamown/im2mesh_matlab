...
% printInp_multiSect: write finite element mesh (nodes and elements) into Inp file 'test_multi_sections.inp',
...
%
    ...
    warning("printInp_multiSect is deprecated. Please use function printInp2d instead.");
