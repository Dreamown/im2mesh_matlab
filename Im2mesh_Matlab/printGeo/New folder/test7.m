% Assume you have already created or loaded 'C'
% C is 1xP, C{i} is 1xS, C{i}{j} is 1xL, C{i}{j}{k} is an Nx1 vector of line indices.

fid = fopen('myGeometry.geo', 'w');
...
fclose(fid);
disp('Gmsh .geo file generated: myGeometry.geo');
