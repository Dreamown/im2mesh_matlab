function printInp_multiPart( nodecoor_cell, ele_cell, ele_type, precision_nodecoor, path_file_name )
%printInp: print the nodes and elements into Inp file 'test_multi_parts.inp',
...
%   
    ...
    if nargin == 4
	    ...
	    path_file_name = 'test_multi_parts.inp';
    elseif nargin == 5
